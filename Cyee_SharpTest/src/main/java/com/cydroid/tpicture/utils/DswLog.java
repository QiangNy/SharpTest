...
public class DswLog {
    ...
    private static String needWriteFile = "recordlog.txt"; // 本类输出的日志文件名称

    public static String LOG_PATH_SDCARD_DIR = "/sdcard/mtklog/picture/Piglog";  // 日志文件在sdcard中的路径
    ...
    public static void setMMILogFile() {
        Date nowtime = new Date();
        needWriteFile = logfile.format(nowtime) + "recordlog.txt";
    }
